...
const inventoryRoutes = require('./routes/inventory'); // Kung may inventory routes ka

const app = express();

app.use(cors());
app.use(express.json());
app.use(bodyParser.json()); // Gumamit ng body-parser
...
app.use('/api/inventory', inventoryRoutes); // Gamitin ang '/api/inventory' para sa inventory routes
